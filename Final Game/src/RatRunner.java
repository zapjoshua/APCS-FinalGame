...
public class RatRunner extends Actor
{
   public static ActorWorld world = new ActorWorld(new BoundedGrid<Actor>(30, 30));
   ...
   public static void main(String[] args) 
   {
       ...
       System.setProperty("info.gridworld.gui.frametitle", "Rat Game");
